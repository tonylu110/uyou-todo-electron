...
function createRepassWindow(uname) {
  ...
  if (isDev)
    repassWindow.loadURL(`http://localhost:3000/electron_windows/pages/repass/`)
  else
    repassWindow.loadFile(path.join(__dirname, '../../dist/electron_windows/pages/repass/index.html'))
